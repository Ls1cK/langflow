          ...
          {hasToolMode && (
            ...
            >
              ...
              >
                ...
                />
                <span className="text-mmd font-medium">{t('flow.toolbar.toolMode')}</span>
                <ToggleShadComponent
                  value={toolMode}
                  editNode={false}
                  handleOnNewValue={() => {
              ...
              >
                ...
                <SelectItem value={"delete"} className="focus:bg-red-400/[.20]">
                  <div className="font-red flex text-status-red">
                    ...
                    />{" "}
                    <span className="">{t('common.delete')}</span>{" "}
                    <span

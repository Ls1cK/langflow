  ...
  const categories: Category[] = [
    {
      ...
      items: [
        {
          title: t("modal:templates.categories.getStarted"),
          icon: "SquarePlay",
          id: "get-started",
        },
        {
          title: t("modal:templates.categories.allTemplates"),
          icon: "LayoutPanelTop",
          id: "all-templates",
        },
      ],
    },
    {
      ...
      items: [
        {
          title: t("modal:templates.categories.assistants"),
          icon: "BotMessageSquare",
          id: "assistants",
        },
        {
          title: t("modal:templates.categories.classification"),
          icon: "Tags",
          id: "classification",
        },
        {
          title: t("modal:templates.categories.coding"),
          icon: "TerminalIcon",
          id: "coding",
        },
        {
        ...
        {
          title: t("modal:templates.categories.qa"),
          icon: "Database",
          id: "q-a",
        },
    ...
    },
    {
      ...
      items: [
        {
          title: t("modal:templates.categories.prompting"),
          icon: "MessagesSquare",
          id: "chatbots",
        },
        {
          title: t("modal:templates.categories.rag"),
          icon: "Database",
          id: "rag",
        },
        {
          title: t("modal:templates.categories.agents"),
          icon: "Bot",
          id: "agents",
        },
      ],
                ...
                <div className="flex w-full flex-col justify-between gap-4 pb-4 sm:flex-row sm:items-center">
                  <div className="flex flex-col items-start justify-center">
                    <div className="font-semibold">
                      {t("modal:templates.startFromScratch")}
                    </div>
